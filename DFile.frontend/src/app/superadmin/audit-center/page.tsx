...
export default function AuditCenterPage() {
    ...
    /** Server clamps page when out of range (e.g. after filters shrink result set). */
            ...
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <Card>
                    <div className="p-5 space-y-3">
                        ...
                        {summaryLoading ? <Skeleton className="h-8 w-16" /> : <p className="text-2xl font-bold">{summary?.byEntity?.length ?? 0}</p>}
                    </div>
                </Card>
            </section>
