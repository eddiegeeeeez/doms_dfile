...
| **Finance** | Tenant | Required | Financial oversight — asset values, depreciation, purchase orders |
| **Maintenance** | Tenant | Required | Maintenance records, task management, employee read access |
